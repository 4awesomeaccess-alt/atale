...
public class invite_sticker_fragment_all extends Fragment {

    private invite_Methods sticker_methods1;
    private ArrayList<invite_ItemSubCat> sticker_arrayList_image_cat;
    private ArrayList<invite_ItemSubCat> sticker_arrayList_text_cat;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewcc = inflater.inflate(R.layout.fragment_invite_sticker_all, container, false);
    ...
    public void refreshData() {
        if (!isDataLoaded) {
            selectedPosition = 0;
            loadCategories(invite_AppConstants.METHOD_CAT_PHOTOSTICKER_All);
        } else {
            showSelectedItem();
        }
    }
    ...
    private class SwipeGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            if (sticker_arrayList_image_cat == null || sticker_arrayList_image_cat.isEmpty()) {
                return false;
            }
    ...
    private void loadCategories(String methodCat) {
        if (sticker_methods1 != null && sticker_methods1.isConnectingToInternet()) {
                    ...
                    try {
                        if ("1".equals(success)) {
                            if (!"-1".equals(verifyStatus)) {
                                ...
                                sticker_progressBar1.setVisibility(View.GONE);
                                sticker_methods1.getVerifyDialog(
                                        getString(R.string.error_unauth_access), message
                                );
                            }
                        } else {
                            sticker_progressBar1.setVisibility(View.GONE);
            ...
            }, sticker_methods1.getAPIRequest(
                    methodCat,
                    0,
                    "",
                    "",
    ...
    private void setEmpty(Boolean isSuccess) {
        ...
        if (isSuccess && sticker_arrayList_image_cat != null && !sticker_arrayList_image_cat.isEmpty()) {
            sticker_ll_empty1.setVisibility(View.GONE);
            ...
            sticker_recyclerView_category.setLayoutManager(layoutManager);
    ...
    private void showSelectedItem() {
        ...
        MainActivity.all_data = new ArrayList<>();

        Fragment fragment = new invite_sticker_lis(
                sticker_arrayList_image_cat.get(selectedPosition).getId()
        );
