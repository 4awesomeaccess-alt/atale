...
public class invite_sticker_fragment_common extends Fragment {
    ...
    private void initview() {
        ...
        sticker_recyclerView_category.setHasFixedSize(true);
            ...
            if (Math.abs(diffX) > Math.abs(diffY)
                ...
                if (diffX < 0) {
                    if (selectedPosition < sticker_arrayList_image_cat.size() - 1) {
                        openSelectedFragment(selectedPosition + 1);
                    }
                } else {
    ...
    private void setEmpty(Boolean isSuccess) {
        ...
        if (isSuccess && sticker_arrayList_image_cat != null && !sticker_arrayList_image_cat.isEmpty()) {
            ...
            sticker_adapterCat.setHasStableIds(true);
    ...
    private void showSelectedItem() {
        ...
        if (newCategoryId.equals(currentLoadedCategoryId)) {
            return;
        }
