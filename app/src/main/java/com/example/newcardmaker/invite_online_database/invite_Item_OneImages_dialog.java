...
public class invite_Item_OneImages_dialog implements Serializable {
    ...
    public invite_Item_OneImages_dialog(String id, String cid, String catName, String img, String ad_on_off) {
        this.id = id;
        this.catId = cid;
