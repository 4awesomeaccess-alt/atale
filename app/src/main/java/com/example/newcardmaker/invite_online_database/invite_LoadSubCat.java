...
public class invite_LoadSubCat extends AsyncTask<String, String, String> {
    ...
    public invite_LoadSubCat(invite_SubCategoryListener subcategoryListener, RequestBody requestBody) {
    ...
    protected String doInBackground(String... strings) {
        try {
            ...
            JSONObject jOb = null;
          Log.println(ASSERT,"#jsonnew ",json);
            ...
            try {
                ...
                for (int i = 0; i < jsonArray_image.length(); i++) {
                    ...
                    Log.println(ASSERT,"json error deta ",c+"");
...
//                    invite_ItemSubCat itemCat = new invite_ItemSubCat(id, cat_id, name, image, ad_on_off, date, detail);
                    invite_ItemSubCat itemCat = new invite_ItemSubCat(id, cat_id, name, image);
