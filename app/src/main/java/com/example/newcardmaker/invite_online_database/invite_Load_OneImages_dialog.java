...
public class invite_Load_OneImages_dialog extends AsyncTask<String, String, String> {

    private RequestBody requestBody;
    private invite_OneImagesListener_dialog quotesListener;
    private ArrayList<invite_Item_OneImages_dialog> arrayList;
    private String verifyStatus = "0", message = "0";
    private int total_records = -1;

    public invite_Load_OneImages_dialog(invite_OneImagesListener_dialog quotesListener, RequestBody requestBody) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (!objJson.has(invite_AppConstants.TAG_SUCCESS)) {
                    ...
                    String ad_on_off = objJson.getString(invite_AppConstants.TAG_AD_ONOFF);
                    ...
                    invite_Item_OneImages_dialog itemQuotes = new invite_Item_OneImages_dialog(id, cid, cat_name, img,ad_on_off);
