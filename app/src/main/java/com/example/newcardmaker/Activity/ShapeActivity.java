...
public class ShapeActivity extends AppCompatActivity {
    ...
    ShapeActivity.ImageAdapter home_adapterImageQuotes;
    ...
    private void fetchImages(String subCatId) {
        ...
        requestBody = home_methods.getAPIRequest(
                ...
                invite_AppConstants.METHOD_IMAGE_PHOTOGREETING10,
                home_page, "", "", "", "", "", "", "", "", "", "", "", "",
    ...
    private void setImageAdapter() {
        if (!home_isScroll) {
            home_adapterImageQuotes = new ShapeActivity.ImageAdapter();
    ...
    // ════════════════════════════════
    private class SubCatAdapter extends RecyclerView.Adapter<ShapeActivity.SubCatAdapter.SCHolder> {

        @Override
        public ShapeActivity.SubCatAdapter.SCHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new ShapeActivity.SubCatAdapter.SCHolder(card, imageView, tvName);
        }

        @Override
        public void onBindViewHolder(ShapeActivity.SubCatAdapter.SCHolder holder, int position) {
    ...
    // Image Adapter
    // ════════════════════════════════
    private class ImageAdapter extends RecyclerView.Adapter<ShapeActivity.ImageAdapter.ImgHolder> {

        @Override
        public ShapeActivity.ImageAdapter.ImgHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            FrameLayout card = new FrameLayout(ShapeActivity.this);
            RecyclerView.LayoutParams lp = new RecyclerView.LayoutParams(
                    RecyclerView.LayoutParams.MATCH_PARENT,
                    RecyclerView.LayoutParams.WRAP_CONTENT);
            ...
            return new ShapeActivity.ImageAdapter.ImgHolder(card, imageView);
        }

        @Override
        public void onBindViewHolder(ShapeActivity.ImageAdapter.ImgHolder holder, int position) {
            invite_Item_OneImages item = home_arrayList.get(position);
