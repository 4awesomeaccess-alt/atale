...
import com.example.newcardmaker.invite_online_database.invite_ItemUser;
...
public class AppConstants {
    ...
    public static final String METHOD_RELESECAT_PHOTOEDTIOR = "get_sub_photo_editor_relese";
    ...
    public static final String METHOD_CAT_PHOTOFRAME = "get_wallpaper_frame";
    public static final String METHOD_RELESECAT_PHOTOFRAME = "get_sub_wallpaper_frame";
    ...
    public static final String METHOD_FRAME_ALL = "get_all_image_photo_frame";
    ...
    public static final String METHOD_IMAGE_PHOTOGREETING = "get_image_greeting_card_frame";
    ...
    public static final String METHOD_GREETING_VIEW = "get_image_greeting_card_frame_View";
    public static final String METHOD_GREETING_DOWNLOAD = "get_image_greeting_card_frame_download";
    ...
    public static final String TAG_CAT_NAME = "category_n" +
            "ame";
    ...
    public static invite_ItemUser itemUser = new invite_ItemUser("", "", "", "", "", "", AppConstants.LOGIN_TYPE_NORMAL);
